	...
	export default {
		...
		data() {
	      ...
	      },
	      {
	        ...
	        'label': '创建金币赛房间数（中式黑8）',
	        'prop': 'user_create_gold_black8_num',
	        'isDefaultHead': true,
	        'isChart': true,
	        'chartType': 'line',
	        'chartGroup': '1',
	        ...
	        'label': '创建金币赛房间数（23分）',
	        'prop': 'user_create_gold_score23_num',
	        'isDefaultHead': true,
	        'isChart': true,
	        'chartType': 'line',
	        'chartGroup': '1',
	        ...
	        'label': '创建免费赛房间数（中式黑8）',
	        'prop': 'user_create_free_black8_num',
	        'isDefaultHead': true,
	        'isChart': false,
	      },{
	        'label': '创建免费赛房间数（23分）',
	        'prop': 'user_create_free_score23_num',
	        'isDefaultHead': true,
	        'isChart': true,
	        'chartType': 'line',
	        'chartGroup': '1',
