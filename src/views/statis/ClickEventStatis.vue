		...
		data() {
	      ...
	      },
	      {
	        ...
	        'itemColor2': 'rgba(219,50,51,0.2)'
				...
				gameUrl: '../loginreg/login_register.json',
				gameType: 'get',
				gameCvs: "../loginreg/loginreg_click_export.json",
				gameGroup: [{
					group: '1',
					id: 'gameChart1',
					title: '积分数',
	      ...
	      },
	      {
	        ...
	        'itemColor2': 'rgba(219,50,51,0.2)'
				...
				gameSecUrl: '../loginreg/info_detail.json',
				gameSecType: 'get',
				gameSecCvs: "../loginreg/loginreg_click_detail_export.json",
				gameSecGroup: [{
					group: '1',
					id: 'gameChart2',
					title: '积分数',
